...
export default function Home() {
  ...
  const handlePushBaga = () => {
    router.push("/baga");
  };

  const handlePushDund = () => {
    router.push("/dund");
  };
  const handlePushAhlah = () => {
    router.push("/ahlah");
  };
  ...
  const handleTetgeleg = () => {
    router.push("/tetgeleg");
  };
  ...
  return (
    <div className=" flex flex-col w-screen h-screen items-center p-8 gap-10 ">
      ...
      <div className=" flex gap-4 flex-col">
        ...
        <div
          className=" p-5 bg-[#222f6e] text-white rounded-lg cursor-pointer hover:bg-[#4054ba] mb-2"
          onClick={handleTetgeleg}
        >
          <button className=" flex m-auto rounded-3xl font-semibold h-[10px] items-center ">
            Тэтгэлэг
          </button>
