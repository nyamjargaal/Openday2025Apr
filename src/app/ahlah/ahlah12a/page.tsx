...
import zurag8 from "../../../assets/12A/8.png"; 
import zurag9 from "../../../assets/12A/9.png";
import zurag10 from "../../../assets/12A/10.png";
import zurag11 from "../../../assets/12A/11.png";
import zurag12 from "../../../assets/12A/12.png";
import zurag13 from "../../../assets/12A/13.png";
    ...
    <div className=" flex flex-col w-screen h-screen items-center p-4 gap-5">
      ...
      <div className=" flex  flex-col gap-4">
        ...
        <div className=" flex flex-col items-center gap-2 p-2 border-r-4 border-r-sky-900 border-b-4 border-b-red-600 border-l-red-600 border-l-4 border-t-4 border-t-sky-800 rounded-2xl">
          <p className="text-center">12A анги нийт 15 суралцагчтай ба 8 эрэгтэй, 7 эмэгтэй.</p>
          <p className="text-center">Ангийн дарга C.Нандин-эрдэнэ </p>
