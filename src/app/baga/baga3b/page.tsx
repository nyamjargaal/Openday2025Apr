...
import zurag1 from "../../../assets/3b/1.png";
import zurag2 from "../../../assets/3b/2.png";
import zurag3 from "../../../assets/3b/3.png";
  ...
  return (
    <div className="flex flex-col w-screen h-screen items-center p-4 gap-5">
      ...
      <div className="flex flex-col gap-4">
        <h1 className="font-bold text-center border-b pb-2 text-[22px] text-red-600">Б.Батмөнх багштай 3B ангийн танилцуулга</h1>
